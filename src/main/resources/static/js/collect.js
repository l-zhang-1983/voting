...
function generateCheckboxes(container, items, groupName) {
    ...
    items.forEach(item => {
        ...
        if (counter % 8 == 0) {
            ...
            lineNo.className = 'col-lg-1 offset-lg-1';
            const lineLabel = document.createElement('label');
            lineLabel.className = 'form-check-label';
            lineLabel.htmlFor = '';
            lineLabel.textContent = (+counter) / 8 + 1;
            lineNo.appendChild(lineLabel)
            lineNo.style = 'padding: 8px 0; font-size: 18px; font-weight: bold;';
        ...
        colContainer.style = 'padding: 8px 0; font-size: 18px; font-weight: bold;';
...
function updateCounts() {
    ...
    document.getElementById('countSupervisor').innerHTML = '<span>' + supervisorChecked + '</span>';
